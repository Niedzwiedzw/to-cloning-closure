...
A5: Clone + 'static
    {
            ...
            B: (Fn(&Self, ) -> R) + Copy + 'static,
        {
            ...
            let tuple = (A0.clone(), A1.clone(), A2.clone(), A3.clone(), A4.clone(), A5.clone(),);
            Box::new(move || {
                builder(&tuple, )
            })
        }
...
A6: Clone + 'static
    {
            ...
            B: (Fn(&Self, ) -> R) + Copy + 'static,
        {
            ...
            let tuple = (A0.clone(), A1.clone(), A2.clone(), A3.clone(), A4.clone(), A5.clone(), A6.clone(),);
            Box::new(move || {
                builder(&tuple, )
            })
        }
...
A7: Clone + 'static
    {
            ...
            B: (Fn(&Self, ) -> R) + Copy + 'static,
        {
            ...
            let tuple = (A0.clone(), A1.clone(), A2.clone(), A3.clone(), A4.clone(), A5.clone(), A6.clone(), A7.clone(),);
            Box::new(move || {
                builder(&tuple, )
            })
        }
    ...
    #[allow(non_snake_case, unused_parens)]
    impl<A0, A1, A2, A3, A4, A5, A6, A7, A8> ToClonedClosure0Args for (A0, A1, A2, A3, A4, A5, A6, A7, A8,)
    where
        A0: Clone + 'static,
A1: Clone + 'static,
A2: Clone + 'static,
...
A8: Clone + 'static
    {
            ...
            B: (Fn(&Self, ) -> R) + Copy + 'static,
        {
            ...
            let tuple = (A0.clone(), A1.clone(), A2.clone(), A3.clone(), A4.clone(), A5.clone(), A6.clone(), A7.clone(), A8.clone(),);
            Box::new(move || {
                builder(&tuple, )
            })
        }
...
A7: Clone + 'static
    ...
    #[allow(non_snake_case, unused_parens)]
    impl<A0, A1, A2, A3, A4, A5, A6, A7, A8> ToClonedClosure1Args for (A0, A1, A2, A3, A4, A5, A6, A7, A8,)
    where
        A0: Clone + 'static,
A1: Clone + 'static,
A2: Clone + 'static,
...
A7: Clone + 'static
    ...
    #[allow(non_snake_case, unused_parens)]
    impl<A0, A1, A2, A3, A4, A5, A6, A7, A8> ToClonedClosure2Args for (A0, A1, A2, A3, A4, A5, A6, A7, A8,)
    where
        A0: Clone + 'static,
A1: Clone + 'static,
A2: Clone + 'static,
...
A7: Clone + 'static
    ...
    #[allow(non_snake_case, unused_parens)]
    impl<A0, A1, A2, A3, A4, A5, A6, A7, A8> ToClonedClosure3Args for (A0, A1, A2, A3, A4, A5, A6, A7, A8,)
    where
        A0: Clone + 'static,
A1: Clone + 'static,
A2: Clone + 'static,
...
A7: Clone + 'static
    ...
    #[allow(non_snake_case, unused_parens)]
    impl<A0, A1, A2, A3, A4, A5, A6, A7, A8> ToClonedClosure4Args for (A0, A1, A2, A3, A4, A5, A6, A7, A8,)
    where
        A0: Clone + 'static,
A1: Clone + 'static,
A2: Clone + 'static,
...
A8: Clone + 'static
    ...
    pub trait ToClonedClosure5Args: Sized {
        fn with_cloned_5<R, B, C0, C1, C2, C3, C4>(&self, builder: B) -> Box<dyn (Fn(C0, C1, C2, C3, C4) -> R)>
        where
...
A7: Clone + 'static
    ...
    #[allow(non_snake_case, unused_parens)]
    impl<A0, A1, A2, A3, A4, A5, A6, A7, A8> ToClonedClosure5Args for (A0, A1, A2, A3, A4, A5, A6, A7, A8,)
    where
        A0: Clone + 'static,
A1: Clone + 'static,
A2: Clone + 'static,
...
A8: Clone + 'static
    ...
    pub trait ToClonedClosure6Args: Sized {
        fn with_cloned_6<R, B, C0, C1, C2, C3, C4, C5>(&self, builder: B) -> Box<dyn (Fn(C0, C1, C2, C3, C4, C5) -> R)>
        where
...
A7: Clone + 'static
    ...
    #[allow(non_snake_case, unused_parens)]
    impl<A0, A1, A2, A3, A4, A5, A6, A7, A8> ToClonedClosure6Args for (A0, A1, A2, A3, A4, A5, A6, A7, A8,)
    where
        A0: Clone + 'static,
A1: Clone + 'static,
A2: Clone + 'static,
...
A8: Clone + 'static
    ...
    pub trait ToClonedClosure7Args: Sized {
        fn with_cloned_7<R, B, C0, C1, C2, C3, C4, C5, C6>(&self, builder: B) -> Box<dyn (Fn(C0, C1, C2, C3, C4, C5, C6) -> R)>
        where
...
A7: Clone + 'static
    ...
    #[allow(non_snake_case, unused_parens)]
    impl<A0, A1, A2, A3, A4, A5, A6, A7, A8> ToClonedClosure7Args for (A0, A1, A2, A3, A4, A5, A6, A7, A8,)
    where
        A0: Clone + 'static,
A1: Clone + 'static,
A2: Clone + 'static,
...
A8: Clone + 'static
    ...
    pub trait ToClonedClosure8Args: Sized {
        fn with_cloned_8<R, B, C0, C1, C2, C3, C4, C5, C6, C7>(&self, builder: B) -> Box<dyn (Fn(C0, C1, C2, C3, C4, C5, C6, C7) -> R)>
        where
...
A7: Clone + 'static
    ...
    #[allow(non_snake_case, unused_parens)]
    impl<A0, A1, A2, A3, A4, A5, A6, A7, A8> ToClonedClosure8Args for (A0, A1, A2, A3, A4, A5, A6, A7, A8,)
    where
        A0: Clone + 'static,
A1: Clone + 'static,
A2: Clone + 'static,
...
A8: Clone + 'static
    ...
    pub trait ToClonedClosure9Args: Sized {
        fn with_cloned_9<R, B, C0, C1, C2, C3, C4, C5, C6, C7, C8>(&self, builder: B) -> Box<dyn (Fn(C0, C1, C2, C3, C4, C5, C6, C7, C8) -> R)>
        where
...
A7: Clone + 'static
    ...
    #[allow(non_snake_case, unused_parens)]
    impl<A0, A1, A2, A3, A4, A5, A6, A7, A8> ToClonedClosure9Args for (A0, A1, A2, A3, A4, A5, A6, A7, A8,)
    where
        A0: Clone + 'static,
A1: Clone + 'static,
A2: Clone + 'static,
